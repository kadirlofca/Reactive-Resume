    ...
    <div className="flex items-center space-x-4">
      <div className="mx-auto w-full">
        ...
        <div className="text-center space-y-0.5 w-full ">
          <div className="text-4xl font-medium">{basics.name}</div>
          <div className="text-base">{basics.headline}</div>

          <div className="flex justify-between flex-wrap items-center gap-x-2 gap-y-0.5 text-base w-full">
            {basics.location && (
...
const Section = <T,>({
  ...
  return (
    <section id={section.id} className="grid">
      <h4 className="mb-2 border-b pb-0.5 text-sm font-medium">{section.name}</h4>
...
export const Haft = ({ columns, isFirstPage = false }: TemplateProps) => {
